...
module RakefileHelpers
  ...
  def load_configuration(config_file)
    unless ($configured)
      $cfg_file = HERE+"../unity/targets/#{config_file}" unless (config_file =~ /[\\|\/]/)
  ...
  def compile(file, defines=[])
    ...
    unity_include = $cfg['compiler']['includes']['prefix']+'../unity/src'
